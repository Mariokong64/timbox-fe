...
type TablaTxtSoporteProps = {
  datos: readonly (readonly CeldaTxt[])[];
};
...
export function TablaTxtSoporte({ datos }: TablaTxtSoporteProps) {
      ...
      >
        ...
        <TableBody>
          {filas.map((fila, filaIndice) => (
            <TableRow key={filaIndice} sx={{ bgcolor: filaIndice % 2 === 1 ? "var(--fondo-timbox)" : "var(--blanco-timbox)" }}>
